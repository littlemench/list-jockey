      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-white">
        <div className="text-center max-w-md">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-neutral-900 hover:bg-neutral-800 text-white font-medium px-8 py-3 rounded-full transition-all hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
          >
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-2xl mx-auto px-6 py-8">
        ...
        <button
          ...
          className="w-full p-5 border border-neutral-300 rounded-2xl text-neutral-500 hover:text-neutral-900 hover:border-neutral-400 transition-all cursor-pointer"
        >
